...
class EvolutionConfig:
    ...
    # LLM configuration
    optimizer_model: str = "openai/google-proxy/gemma-4-31b-it"  # Model for GEPA reflections
    eval_model: str = "openai/google-proxy/gemma-4-31b-it"  # Model for LLM-as-judge scoring
