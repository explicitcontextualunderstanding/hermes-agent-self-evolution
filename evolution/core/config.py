...
class EvolutionConfig:
    ...
    # LLM configuration
    optimizer_model: str = "openai/nvidia-proxy/meta/llama-3.1-405b-instruct"  # Model for GEPA reflections
    eval_model: str = "openai/nvidia-proxy/moonshotai/kimi-k2.5"  # Model for LLM-as-judge scoring
    judge_model: str = "openai/nvidia-proxy/meta/llama-3.1-405b-instruct"  # Model for dataset generation
